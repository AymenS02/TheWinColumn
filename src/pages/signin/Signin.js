...
function Signin() {
    ...
    return (
        <div className="flex flex-col items-center w-full">
            <div className="flex flex-col items-center justify-center bg-gray-800 text-gray-100 border-gray-100 mt-10 p-8 rounded-[1rem] border-2 shadow-lg w-[50vh]">
                <h1 className="mt-4 mb-4 text-3xl">Log In!</h1>
                <form className="flex flex-col min-w-[40vh] mt-4" onSubmit={submit}>
                    <div className="flex flex-col mb-4">
                        <label htmlFor="email" className="mb-2">Email</label>
                        <input type="email" onChange={(e) => setEmail(e.target.value)} placeholder="Email" className="w-full h-8 p-2 border rounded-md text-gray-800"/>
                    </div>
                    <div className="flex flex-col mb-4">
                        <label htmlFor="password" className="mb-2">Password</label>
                        <input type="password" onChange={(e) => setPassword(e.target.value)} placeholder="Password" className="w-full h-8 p-2 border rounded-md text-gray-800"/>
                    </div>
